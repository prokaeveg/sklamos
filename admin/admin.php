...
<div class="container">
  ...
  <h1 class="main_title_admin">Ты почти Бог на этом сайте</h1>
      <div class="add_item">
        <a href="add_to_db.php" class="button">Добавить товар в каталог</a>
      </div>
      <div class="add_item">
        <a href="edit_db.php" class="button">Редактировать товары</a>
      </div>
      <div class="add_item">
        <a href="remove_from_db.php" class="button">Удалить товары</a>
      </div>
      <div class="add_item">
        <a href="show_users.php" class="button">Посмотреть пользователей</a>
      </div>
<div class="row">
