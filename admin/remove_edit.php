...
<head>
  ...
  <link rel="stylesheet" href="../css/style.css">
  <link rel="stylesheet" href="../css/remove_edit.css">
        ...
        echo '
          <li>
            ...
            <div class="row">
              ...
              <a href="edit_db.php?edit_id='.$row['product_id'].'" class="edit">edit</a>
              <a href="?del_id='.$row['product_id'].'" class="delete">delete</a>
            </div>
          </li>
        ';
