...
<div class="content">
  <div class="container wrapper">
    ...
    <center><h1>Редактирование</h1></center>
    <div class="add_item ">
    ...
    <form class="add_form " action="" method="POST">
      <p>
        <label for="title ">Name</label>
          <input class="data title" type="text " name="title" value="<?php  echo $row['title'];?>" required>
      </p>
      <p>
        <label for="price ">Price</label>
          <input class="data price" type="text " name="price" value="<?php   echo $row['price'];?>" required>
      </p>
      <p>
        <label for="image ">Image</label>
          <input class="data image" type="text " name="image" value="<?php   echo $row['image'];?>" required>
      </p>
      <p>
        <label for="mini_desc ">Mini description</label>
          <input class="data features" type="text " name="mini_desc" value="<?php   echo $row['mini_description'];?>" required>
      </p>
      <p>
        <label for="mini_features ">Mini features</label>
          <input class="data features" type="text " name="mini_features" value="<?php   echo $row['mini_features'];?>" required>
      </p>
      <p>
        <label for="visability ">Visability</label>
          <input class="data features" type="text " name="visability" value="<?php   echo $row['visible'];?>" required>
      </p>
  ...
  <?php 
    ...
    $mini_desc = check_symbol ($mini_desc, "Mini description ", "1", "/[а-яёА-ЯЁa-zA-Z0-9]/ ");
    $mini_features = $_POST['mini_features'];
    $mini_features = check_symbol ($mini_features, "Mini features ", "1", "/[а-яёА-ЯЁa-zA-Z0-9]/ ");
    $visability = $_POST['visability'];
    $visability = check_symbol ($visability, "Visability", "1", "/[0-1]/ ");
    ...
    if (!empty($GLOBALS['alert'])) {
      ...
      $query = "UPDATE products SET title='$title', price='$price', image='$image', 
        mini_description='$mini_desc', mini_features='$mini_features', visible='$visability' WHERE product_id = '$id'";
